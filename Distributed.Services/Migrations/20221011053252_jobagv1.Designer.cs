...
namespace Distributed.Services.Migrations
{
    ...
    [Migration("20221011053252_jobagv1")]
    partial class jobagv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOfferSavedJobOffers", b =>
                {
                    b.Property<int>("JobOffersId")
                        .HasColumnType("int");

                    b.Property<int>("SavedJobOffersId")
                        .HasColumnType("int");

                    b.HasKey("JobOffersId", "SavedJobOffersId");

                    b.HasIndex("SavedJobOffersId");

                    b.ToTable("JobOfferSavedJobOffers");
                });
            ...
            modelBuilder.Entity("PostulantSavedJobOffers", b =>
                {
                    b.Property<int>("PostulantsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PostulantsId", "SavedJobOffersId");

                    b.HasIndex("SavedJobOffersId");

                    b.ToTable("PostulantSavedJobOffers");
                });
            ...
            modelBuilder.Entity("JobOfferSavedJobOffers", b =>
                {
                    ...
                    b.HasOne("Domain.MainModule.Entity.SavedJobOffers", null)
                        .WithMany()
                        .HasForeignKey("SavedJobOffersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
